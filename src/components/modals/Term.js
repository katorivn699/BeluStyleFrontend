        ...
        <Fade in={isTermsOpen} timeout={500}>
          <Box sx={modalStyle}>
            ...
            <Typography variant="body1" paragraph>
              Welcome to BeluStyle. By using our website and services, you agree
            ...
            <Typography variant="body1" paragraph>
              ...
              BeluStyle or our licensors. Unauthorized use is prohibited.
            </Typography>
            <Typography variant="body1" paragraph>
      ...
      <Modal open={isPrivacyOpen} onClose={() => setPrivacyOpen(false)}>
        <Fade in={isPrivacyOpen} timeout={500}>
          <Box sx={modalStyle}>
            ...
            <Typography variant="body1" paragraph>
              BeluStyle is committed to protecting your personal information.
