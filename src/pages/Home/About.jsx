  ...
  return (
    <MainLayout>
      <div className="grid grid-cols-1 md:grid-cols-3 px-4 md:px-40 py-10 items-center">
        ...
        <div className="AboutRight flex justify-center md:justify-end mt-10 md:mt-0">
          <img src={logo} alt="logo BeluStyle" className="w-1/2 md:w-full" />
        </div>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 w-full bg-blueOcean">
        <div className="reason px-8 md:px-32 py-16 md:py-32">
          <Lottie animationData={FiveWhy} loop={false} />
        </div>
